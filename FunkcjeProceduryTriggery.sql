...
GO
--------------------------------------------------------------
IF OBJECT_ID('TOP_10_NAJBARDZIEJ_AKTYWNYCH_KLIENTOW_MIESIACA)', 'P') IS NOT NULL DROP PROC TOP_10_NAJBARDZIEJ_AKTYWNYCH_KLIENTOW
GO
CREATE PROCEDURE TOP_10_NAJBARDZIEJ_AKTYWNYCH_KLIENTOW AS
BEGIN
	SELECT O.ID_OSOBY, O.IMIE, O.NAZWISKO FROM OSOBA O JOIN [Wejscia na obiekty] W ON O.ID_OSOBY = W.ID_KLIENTA
	WHERE W.DATA BETWEEN DATEADD(MONTH, -1, GETDATE()) AND GETDATE()
END
GO
