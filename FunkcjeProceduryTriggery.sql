...
GO
--------------------------------------------------------------
IF OBJECT_ID('OSOBA_ZABEZPIECZENIE_INS_DEL', 'TR') IS NOT NULL DROP TRIGGER OSOBA_ZABEZPIECZENIE_INS_DEL
GO
CREATE TRIGGER OSOBA_ZABEZPIECZENIE_INS_DEL ON OSOBA
AFTER INSERT, DELETE AS
	PRINT 'DODAWANIE, USUWANIE OSOBY ODBYWA SIE POPRZEZ UZYCIE METOD USUN_KLIENTA/USUN_PRACOWNIKA'
...
CREATE TRIGGER OSOBA_ZABEZPIECZENIE_INS_DEL ON OSOBA
AFTER INSERT, DELETE AS
	PRINT 'DODAWANIE, USUWANIE OSOBY ODBYWA SIE POPRZEZ UZYCIE METOD USUN_KLIENTA/USUN_PRACOWNIKA, DODAJ_KLIENTA/DODAJ_PRACOWNIKA'
	PRINT 'OPERACJA ANULOWANA'
	ROLLBACK
GO
--------------------------------------------------------------
IF OBJECT_ID('KLIENT_ZABEZPIECZENIE_INS_DEL', 'TR') IS NOT NULL DROP TRIGGER KLIENT_ZABEZPIECZENIE_INS_DEL
GO
CREATE TRIGGER KLIENT_ZABEZPIECZENIE_INS_DEL ON KLIENT
AFTER INSERT, DELETE AS
	PRINT 'DODAWANIE, USUWANIE KLIENTA ODBYWA SIE POPRZEZ UZYCIE METOD USUN_KLIENTA, DODAJ_KLIENTA'
	PRINT 'OPERACJA ANULOWANA'
	ROLLBACK
GO
--------------------------------------------------------------
IF OBJECT_ID('PRACOWNIK_ZABEZPIECZENIE_INS_DEL', 'TR') IS NOT NULL DROP TRIGGER PRACOWNIK_ZABEZPIECZENIE_INS_DEL
GO
CREATE TRIGGER PRACOWNIK_ZABEZPIECZENIE_INS_DEL ON PRACOWNIK
AFTER INSERT, DELETE AS
	PRINT 'DODAWANIE, USUWANIE PRACOWNIKA ODBYWA SIE POPRZEZ UZYCIE METOD USUN_PRACOWNIKA, DODAJ_PRACOWNIKA'
	PRINT 'OPERACJA ANULOWANA'
	ROLLBACK
GO
--------------------------------------------------------------